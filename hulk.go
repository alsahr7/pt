...
/*
    HULK DoS tool enhanced by joo Goo from P.T.Y team.
    Originally ported from Python with some improvements.
    This Go program is licensed under GPLv3.
    Copyright joo Goo <email@example.com>
*/
